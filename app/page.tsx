...
import { AlertTriangle, Bug, Cake, Cookie, CreditCard, Egg, Rabbit, ShoppingCart, Utensils, X } from "lucide-react"
...
export default function BrokenPage() {
    ...
    const errorInterval = setInterval(
      () => {
        if (errorMessages.length < 8) {
          // Reduced for mobile
          const newError = possibleErrors[Math.floor(Math.random() * possibleErrors.length)]
  ...
  return (
    <div className={`min-h-screen bg-purple-50 overflow-hidden relative ${shake ? "animate-shake" : ""}`}>
      {/* Broken header */}
      <header className="bg-yellow-200 p-3 flex justify-between items-center animate-glitch">
        <div className="flex items-center gap-1">
          ...
          <h1 className="text-lg font-bold glitch-text text-purple-700">Bakermester Harepus</h1>
        </div>
      ...
      <main className="container mx-auto p-3 relative">
        ...
        <section className="mt-8 bg-pink-50 p-4 shadow-lg relative overflow-hidden skew-x-1 border-2 border-yellow-300">
          ...
          <h2 className="text-2xl font-bold mb-3 glitch-text-severe text-purple-700">
            Velkommen til <span className="line-through">Påskebutikken</span> Katastrofen
          </h2>

          <div className="flex flex-col gap-4 items-center">
            <div className="w-full prose glitchy-text text-sm">
              <p className="animate-text-corrupt text-blue-600">
                Vi opplever noen <span className="text-red-500">tekniske problemer</span> med påskebutikken vår. Våre{" "}
                <span className="animate-float inline-block text-purple-600">påskeharer</span> jobber hardt for å fikse
                problemene.
              </p>

              <p className="mt-3 animate-text-corrupt-delay text-green-600">
                Vær tålmodig mens vi <span className="text-blue-500">forsøker</span> å få butikken opp igjen. I
                mellomtiden, nyt <span className="text-pink-500">påskekaoset</span>!
              </p>

              <button
                className="mt-3 bg-gradient-to-r from-yellow-400 to-pink-400 text-purple-900 px-4 py-2 rounded hover:animate-wiggle w-full font-bold"
        ...
        <div className="mt-8 flex justify-between items-center">
          <h2 className="text-xl font-bold glitch-text text-purple-700">Våre Påskeprodukter</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="h-32 w-32 bg-pink-100 flex items-center justify-center relative mx-auto sm:mx-0 border-2 border-purple-200">
                  ...
                  <div className="text-purple-400 flex flex-col items-center">
                    {React.createElement(product.icon, { className: "h-8 w-8 mb-1" })}
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <h3 className="text-lg font-bold mb-1 glitch-text text-purple-700">{product.name}</h3>
                    <span className="text-lg font-bold corrupt-text animate-text-corrupt text-pink-600">
                      {product.price}
                    </span>
                  </div>
                  <p className="text-blue-600 corrupt-text text-sm mb-3">{product.description}</p>
        ...
        <section className="mt-8 bg-blue-50 p-4 shadow-lg relative overflow-hidden border-2 border-pink-300">
          ...
          <div className="border-t border-b border-yellow-300 py-3 mb-3">
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm corrupt-text text-green-600">Påskebolle Deluxe</span>
              </div>
              <span className="text-sm animate-text-corrupt text-pink-600">39,90 kr</span>
            </div>
            ...
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm corrupt-text text-green-600">Sjokoladeegg</span>
              </div>
              <span className="text-sm animate-text-corrupt text-pink-600">45,00 kr</span>
            </div>
          ...
          <div className="mt-3 bg-pink-100 border-l-4 border-purple-400 text-purple-700 p-3 animate-slide-in text-sm">
            ...
            <p>Betalingssystemet er for øyeblikket utilgjengelig på grunn av påskeferie.</p>
          </div>
        </section>
      </main>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col space-y-4">
            <div className="animate-float">
              <h3 className="text-lg font-bold mb-2 glitch-text text-yellow-200">Om Bakermester Harepus</h3>
              <p className="corrupt-text text-sm text-pink-200">
                Vi har bakt de beste påskeverkene i byen siden 1995, men nå er påskebutikken vår ødelagt.
              </p>
            </div>

            <div className="animate-float-delay">
              <h3 className="text-lg font-bold mb-2 glitch-text text-yellow-200">Påskeåpningstider</h3>
            ...
            <div className="animate-float-more-delay">
              <h3 className="text-lg font-bold mb-2 glitch-text text-yellow-200">Påskenyhetsbrev</h3>
              <p className="mb-2 corrupt-text text-sm text-pink-200">
                Abonner på nyhetsbrevet vårt for å motta oppdateringer og påskerabattkoder.
              </p>
              <div className="flex">
                <input
                  type="email"
      ...
      {showEasterEgg && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-70">
          <div className="bg-yellow-100 p-4 rounded-lg shadow-lg max-w-xs text-center animate-bounce-in mx-4 border-4 border-pink-400">
            <h3 className="text-xl font-bold mb-3 text-purple-700">🐰 Påskens Spesial! 🥚</h3>
            <p className="mb-3 text-sm text-green-600">
              Gratulerer! Du har funnet påskens spesial: Gigantisk sjokoladeegg med 50% rabatt!
            </p>
            <p className="text-xs text-pink-600">Dessverre er påskebestillingssystemet nede. 😉</p>
          </div>
        </div>
      )}
          ...
          <div className="flex items-start">
            ...
            <div className="ml-2">
              ...
              <div className="mt-1 text-xs text-green-600">
                <p>En uventet feil har oppstått i påskeeggproduksjonen. Vennligst prøv igjen senere.</p>
              </div>
            </div>
          </div>
        </div>
